        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Home Page</h4>
              
              <!-- Grid Card -->
          
              <div class="row row-cols-1 row-cols-md-3 g-4 mb-5">
              <?php foreach($prodInfo as $product){?>
                <div class="col">
                  <div class="card h-100">
                     <?php echo '<img height="300px" width="390px" src="data:image;base64,'.$product['image'].'">'?>
                    <div class="card-body">
                      <h5 class="card-title"><a href="productinfo.php?id=<?php echo $product['id'];?>"><?php echo $product['title'];?></a></h5>
                      <p class="card-text">
                      <?php echo $product['price'].''.'EGP'.'&nbsp'.'<br>'; if($product['stock']>1){echo 'In Stock';} else{echo 'Out Of Stock';}?>
                      </p>
