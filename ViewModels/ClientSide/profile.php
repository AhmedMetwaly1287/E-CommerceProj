              ...
              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                      <a class="nav-link active" href="editprofile.php"><i class="bx bx-user me-1"></i> Edit Account</a>
                    </li>
                  </ul>
                  <div class="card mb-4">
                      ...
                      <form id="formAccountSettings" method="POST" onsubmit="return false">
                        ...
                        <!--    <label for="firstName" class="form-label">First Name</label>
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <label class="form-label" for="basic-default-fullname"><strong><?php echo $user['email']; ?></strong>
                            
                          </label><br>
                          </div> 
                          <label for="email" class="form-label">First name:</label><br>
                          <label class="form-label" for="basic-default-fullname"><strong><?php echo $user['fname']; ?></strong>
                        
                            </div>
                            <label for="email" class="form-label">Last name:</label>
                            <label class="form-label" for="basic-default-fullname"><strong><?php echo $user['lname']; ?></strong>
