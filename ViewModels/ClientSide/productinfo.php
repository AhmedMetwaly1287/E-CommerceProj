        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Product Info</h4>
              ...
              <?php foreach($prodInfo as $product){?>
                <div class="col">
                  ...
                  <?php echo '<img src="data:image;base64,'.$product['image'].'">'?>
                    <div class="card-body">
                      <h5 class="card-title"><?php echo $product['title'];?></h5>
                      <p class="card-text">
                      <?php echo $product['price'].''.'EGP'.'&nbsp'.'<br>'; echo 'Bio: '.$product['bio'].'<br>'; echo 'Available Sizes: '.$product['sizes'].'<br>'; if($product['stock']>1){echo 'In Stock';} else{echo 'Out Of Stock';}?>
                      </p>
