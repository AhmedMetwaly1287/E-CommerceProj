...
if(isset($_POST['pinform'])){
  if(!empty($_POST['pinform'])){
    if(session_start()){
      $pinform = $_POST['pinform'];
      $pin = $_SESSION['pin'];
      ...
      if($DB->OpenCon()){
        if($pinform==$pin){
          ...
          $errMsg = 'The PIN code entered is incorrect';
        }
      }
        ...
        <div class="authentication-inner py-4">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-4">Enter the PIN Code you were emailed</p>
              <form id="formAuthentication" class="mb-3" action="" method="POST">
                ...
                <button class="btn btn-primary d-grid w-100">Enter PIN</button>
              </form>
