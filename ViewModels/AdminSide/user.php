...
if(isset($_SESSION['roleID'])){
  if(!$auth->checkAdmin()){
    ...
    if($DB->OpenCon()){
    $users = $userCon->getAll();

    //WIP
    //Manage Products (Add-Edit-Delete)
    //Manage Users (Change role)
    //Show List of Products in products Page with an Edit Button by each one
    //Redirection to the correct pages
    //Show list of users in users page with an Edit button by each one
  }
}
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Admin Dashboard</span></h4>
                  ...
                  <table class="table">
                    <thead>
                      <tr>
                        ...
                        <th>Last Name</th>
                        <th>Email</th>
                        <th>Role ID <br><small class="text-muted">1 for Client, 0 for Admin</small></th>
                        <th>Actions</th>
                      </tr>
                    </thead>
...
<?php foreach($users as $user){
                      ?>
                        <tr>
                          <form method ="GET">
                          <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <?php echo $user['id']; ?></td>
                          ...
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="edituser.php?id=<?php echo $user['id'];?>"
                                ><i class="bx bx-edit-alt me-2"></i> Edit</a
                              >
                              <a class="dropdown-item" href="deleteuser.php?id=<?php echo $user['id'];?>"
