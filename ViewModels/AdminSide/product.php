...
<?php foreach($products as $prod){
                      ?>
                        <tr>
                          <form method ="GET">
                          <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <?php echo $prod['id']; ?></td>

                          <td><strong><?php echo $prod['title'];?></strong></td>
                          <td><?php echo '<strong>';echo $prod['price'];echo '</strong>'; echo'EGP'; ?></td>
                          <td><?php echo $prod['bio']; ?></td>
                          <td><?php echo $prod['sizes']; ?></td>
                          <td>
                            <?php echo $prod['stock'];?>
                          </td>
                          <td>
                            <a href="viewimage.php?id=<?php echo $prod['id']?>"> View </a>
                          </td>
                          <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="editproduct.php?id=<?php echo $prod['id'];?>"
                                ><i class="bx bx-edit-alt me-2"></i> Edit</a
                              >
                              <a class="dropdown-item" href="deleteproduct.php?id=<?php echo $prod['id'];?>"
