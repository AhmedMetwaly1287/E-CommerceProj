...
$res = count($prodCon->NoOfProduct());
$res1 = count($userCon->NoOfUsers());
if(!$auth->checkAdmin()){
                ...
                <div class="card h-100">
                  <div class="card-header d-flex align-items-center justify-content-between pb-0">
                    <div class="card-title mb-0">
                      <h5 class="m-0 me-2">Website Statistics</h5><br>
                    </div>
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-end" aria-labelledby="orederStatistics">
                        <a class="dropdown-item" href="index.php">Refresh</a>
                      </div>
                    </div>
                  </div>
                  <div class="card-body">
                    ...
                    <ul class="p-0 m-0">
                      <li class="d-flex mb-4 pb-1">
                        ...
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                          <div class="me-2">
                            <h6 class="mb-0"><a href="user.php">Users</a></h6>
                      ...
                      <li class="d-flex mb-4 pb-1">
                        ...
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                          <div class="me-2">
                            <h6 class="mb-0"><a href="product.php">Products</a></h6>
